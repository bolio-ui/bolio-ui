...
export const BrowserInvert: StoryFn = () => (
  <Grid.Container gap={2}>
    <Grid>
  ...
  <Grid.Container gap={2}>
    <Grid>
      <Display
        ...
        caption={
          <p>
            Reduce the possibility of page rendering by setting{' '}
            <Code>height</Code>
          </p>
        }
      >
...
export const SVG: StoryFn = () => {
  ...
  return (
    <Grid.Container gap={2}>
      <Grid>
        <Image width="100px" height="50px" src={svg} />
      </Grid>
    </Grid.Container>
  )
}
