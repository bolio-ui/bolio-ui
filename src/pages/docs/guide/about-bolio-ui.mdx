...
- • Major versions (X.0.0) are deployed when there are significant changes that necessitate breaking compatibility.
  Usually, a new major version is released approximately every 6 months to 1 year.
