...
export const meta = {
  ...
  description: 'Set up Bolio UI in a RedwoodJS application.',
  sidebar: 'guide',
  group: 'Guide'
}
...
Follow <Link target="_blank" rel="nofollow" color icon href="https://redwoodjs.com/docs/quick-start"> Redwood getting started</Link> guide to create new Redwood application:
