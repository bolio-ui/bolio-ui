...
import { Card, Grid, Fieldset, Button, Text, Divider } from 'core'
...
<Playground
  ...
  scope={{ Fieldset, Button, Text, Grid }}
  code={`
<Grid.Container gap={2}>
  <Grid>
    <Fieldset>
...
<Attributes edit="/content/docs/components/fieldset.mdx">
