...
import { Tooltip, Grid, Button, Link, Badge, Code, Text } from 'core'
...
<Playground
  ...
  scope={{ Tooltip, Button, Link, Grid, Badge }}
  code={`
<Grid.Container gap={2}>
  <Grid>
...
<Attributes edit="/content/docs/components/tooltip.mdx">
...
| **ghost**           | outline variant: page background, colored border           | `boolean`                     | -               | `false`   |
