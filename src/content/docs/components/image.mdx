...
import { Image, Display, Code, Grid } from 'core'
...
<Playground
  ...
  desc="You can apply a color invert with the `invert` prop."
  scope={{ Image, Display, Code, Grid }}
  code={`
<Grid.Container gap={2}>
  <Grid>
...
<Attributes edit="/content/docs/components/image.mdx">
