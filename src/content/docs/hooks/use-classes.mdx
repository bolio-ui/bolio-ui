...
there are not a lot of complex class-names expressions to deal with in _Bolio UI_, just for regular space sign removal.
...
<Attributes edit="/content/docs/hooks/use-classes.mdx">
