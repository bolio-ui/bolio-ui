...
export const meta = {
  title: 'useScale',
  description:
    'Remember the elastic scaling feature mentioned in the subsection, which gave the Bolio UI components amazing imagination and extensibility.',
  sidebar: 'hooks',
  group: 'Hooks',
  index: 10
}
...
Remember the elastic scaling feature mentioned in the [scale](/docs/hooks/use-scale#scale-the-width 'Scale') subsection,
which gave the Bolio UI components amazing imagination and extensibility,
...
Now we try to bind the component to the scale of Bolio UI:

```tsx
import { withScale, useScale } from '@bolio-ui/core'
...
<Attributes edit="/content/docs/hooks/use-scale.mdx">
